...
class ProductList extends React.Component{
  ...
  render(){
    ...
    return (
      ...
      <div className="row">
          {this.state.products.map(prod=><ProductTummb key={prod._id} productType={this.props.listType} product={prod} />)}

      </div>
          <div className='centeredDiv'>
          <Pagination  items={this.state.pagesNumber} activePage={1} maxButtons={8} onSelect={this.onPageSelect.bind(this)} />
          </div>
        </div>
    )
  }
